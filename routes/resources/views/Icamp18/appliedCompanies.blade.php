...
@section('title', 'Applied Startups - Internshipcamp \'18') 
@section('css')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" id="but_remove" name="">Remove Startup</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript" src="/Icamp18/assets_dash/js/companyApplied.js">

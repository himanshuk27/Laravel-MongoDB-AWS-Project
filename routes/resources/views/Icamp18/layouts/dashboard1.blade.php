...
<head>
	...
	<title>Companies List- Internship Camp '18</title>
				...
				<div class="m-container m-container--responsive m-container--xxl m-container--full-height m-page__container">
					<div class="m-stack m-stack--ver m-stack--desktop">		
						...
						<div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav"  >
							<div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general" style="display:none;">
									...
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										...
										<li class="m-menu__item{{ Request::is('profile') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="#" class="m-menu__link ">
												...
												<span class="m-menu__link-text" style= "font-size:25px; padding-left:50px">List of Companies</span>
											</a>
										</li>

...
<html lang="en" >
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-2" id="m_login" style="background-image: url(/Icamp18/assets_dash/img/bg-3.jpg);">
				<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
					...
					<h3 class="m-login__title">Sign In To Internship Camp '18 Company Dashboard</h3>
				</div>
							
							<form id="loginForm" name="loginForm" class="m-login__form m-form" action="/login/auth/company">
		...
		<script src="/Icamp18/assets_dash/js/companyLogin.js" type="text/javascript"></script>

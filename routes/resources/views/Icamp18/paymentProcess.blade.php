	...
	<div class="row ">
		<div class="col-md-12">
			<div id="m_chart_profit_share" class="m-widget14__chart" style="height: 100px">		       	
				...
				<p class="m-widget14__stat m--font-danger">Payment Processing... </p>					
			</div>			
		</div>	
		<br>
		<h5>Calm Down, your payment may take upto 20 mins to process. You will recieve a confirmation email once done.</h5>
</div>
<div class="row">
	&nbsp;
</div>

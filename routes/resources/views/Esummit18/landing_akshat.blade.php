...
-->
            <div class="portfolio portfolio-with-title col-4 gutter mt-50">
                <h2 style="font-weight: bold;">Youtuber Sessions</h2>
                <div class="portfolio-item" data-groups='["all", "branding", "photography"]'>

                    <div class="portfolio-wrapper">
                        <div class="thumb">
                            <div class="bg-overlay"></div>
                            <img src="https://esummit.org.in/Esummit18/assets/img/logo-ecell.png" alt="">
                            <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="https://esummit.org.in/Esummit18/assets/img/logo-ecell.png" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="portfolio portfolio-with-title col-4 gutter mt-50">
                ...
                <div class="portfolio-item" data-groups='["all", "branding", "photography"]'>
                    ...
                    <div class="portfolio-wrapper">
                        ...
                        <div class="portfolio-title">
                            <h2><a href="#">Creatives Design</a></h2>
                            <p><a href="#">iOS Design</a> </p>
                        </div>
                    </div>
                </div>

		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				...
				<h3 class="m-portlet__head-text">
					Payment Portal &nbsp;&nbsp;&nbsp; <span color="red">(Early Bird Registrations Closing Soon)</span>
				</h3>
			</div>
		</div>
	</div>
			...
			<div class="m-pricing-table-1__items row">
				...
				<div class="m-pricing-table-1__item col-lg-3">
					<div class="m-pricing-table-1__visual">
						<div class="m-pricing-table-1__hexagon1"></div>
						<div class="m-pricing-table-1__hexagon2"></div>
						<span class="m-pricing-table-1__icon m--font-primary"><img style="width: 70%;" src="//interncamp.ecell.org.in/logo"></span>
					</div>
					<span class="m-pricing-table-1__price">Icamp Value Pack</span> 
					<br>				 

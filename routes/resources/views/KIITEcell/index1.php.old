...
$pageid = "Home";
$title = 'Entrepreneurship Cell | KIIT University';
...
?>
		...
		<div role="main" class="main">
		 <a href="startup-india.php" style="text-decoration:none">
		     <section class="">
					<div class="container">
						<div class="row">
							<div class="col-sm-12">
							<figure>
							    <img src="assets/startup-yatra/rathyatra.jpg" alt="" style="height:400px;min-width:100%" class="img-responsive"><br>
							    <figcaption>
							       <center>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="get-started">
								<a href="register_startup" class="btn btn-lg btn-primary">Get Started Now!</a>
								<div class="learn-more">or <a href="about-us">learn more.</a></div>
							</div>
						</div>
					</div>					
				</div>
				...
				<section class="section section-default mt-none mb-xl">
					...
					<div class="home-concept appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
						<svg class="home-concept-bg" x="0px" y="0px" width="345px" height="93px" viewBox="0 0 345 83" enable-background="new 0 0 345 93" xml:space="preserve">
							<image overflow="visible" width="26" height="39" xlink:href="assets/images/home-concept-pin.png" transform="matrix(0.169 0.1308 -0.1308 0.169 339.8496 0.6826)" class="final-pin appear-animation" data-appear-animation="animated-pin" data-appear-animation-delay="3650">
							</image>
							...
							<image overflow="visible" width="26" height="39" xlink:href="assets/images/home-concept-pin.png" transform="matrix(0.2137 0 0 0.2137 1 81.5898)" class="initial-pin appear-animation" data-appear-animation="animated-pin">
							</image>
						</svg>
						<div class="container">
								...
								<div class="col-md-2 col-md-offset-1">
									<div class="process-image">
										<div class="box-image">
											...
											<img src="assets/images/imagine-concept.png" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="1400" />
										</div>
								...
								<div class="col-md-2">
									<div class="process-image">
										<div class="box-image">
											...
											<img src="assets/images/innovate-concept.png" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="1900" />
										</div>
								...
								<div class="col-md-2">
									<div class="process-image">
										<div class="box-image">
											...
											<img src="assets/images/implement-concept.png" alt="" class="appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="2400" />
										</div>
									...
									<div class="project-image">
										<div class="box-image">
											...
											<div id="fcSlideshow" class="fc-slideshow appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="2900">
												<ul class="fc-slides">
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="assets/images/logo.png" alt="" /></a></li>
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="assets/images/logo.png" alt="" /></a></li>
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="assets/images/logo.png" alt="" /></a></li>
												</ul>
											</div>
					...
					<div class="row">
							...
							<div class="featured-box featured-box-primary">
								<div class="box-content">
									<table>  <tr>
										...
										<th class="tg-yw4l" rowspan="3"><img class="img-responsive" src="assets/images/founder.png"></th>
									</tr>  
						...
						<div class="featured-box featured-box-quaternary featured-box-effect-3">
							<div class="box-content">
								<table class="tg">
									<tr>
										<th class="tg-031e" rowspan="2"><img class="img-responsive" src="assets/images/artofgiving.jpg"></th>

...
$pageid = "Initiatives";
$title = 'TBI Initiatives - Ecell | KIIT University';
				...
				<hr class="tall">
					...
					<div class="row" id="prayas">
							...
							<div class="owl-carousel owl-theme" data-plugin-options='{"items": 1, "margin": 10}'>
								<div>
									<span class="img-thumbnail">
										<img alt="" class="img-responsive" src="assets/tbi/nidhi-thumb.jpg">
									</span>
								</div>
								<div>
									<span class="img-thumbnail">
										<img alt="" class="img-responsive" src="assets/tbi/nidhi-thumb2.jpg">
									</span>
								</div>								
							</div>
						...
						<div class="col-md-8">
                            ...
                            <a href="assets/tbi/NIDHI-PRAYAS-Application-form.doc" class="btn btn-primary btn-icon"><i class="fa fa-external-link"></i>Download Application Form</a> 
										...
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												...
												<div class="modal-body">
													<img alt="" class="img-responsive" src="assets/tbi/PRAYAS-Brochure.jpg">
												</div>

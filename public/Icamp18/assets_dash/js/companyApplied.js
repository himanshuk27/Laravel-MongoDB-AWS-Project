...
$('.card').click(function(e) {
        ...
        $("#loader").css("display","block");
         $("#but_remove").css("display","none");
         $("#but_bookmark").css("display","none");
            ...
            if( response.type=='success' ){
                 $("#loader").css("display","none");
                  $("#modal-body").css("display","block");
                   $("#but_remove").css("display","block");
                  $("#but_bookmark").css("display","block");
                ...
                $('#but_remove').attr('name', response.ic_id);
                $('#but_bookmark').attr('name', response.ic_id);
...
$('#but_remove').click(function(e) {
        ...
        var btn = $(this);
        var comp_id = btn.attr('name');
        var action = '/startup/remove/'+comp_id; 
        var data = {            
            '_token': _token
        };
         ...
         swal({
                ...
                text: "Proceed to remove this Startup from your profile",
                type: 'warning',
...
$('#but_bookmark').click(function(e) {
        ...
        var btn = $(this);
        var comp_id = btn.attr('name');
        var action = '/startup/addBookmark/'+comp_id; 
        var data = {            
            '_token': _token
        };

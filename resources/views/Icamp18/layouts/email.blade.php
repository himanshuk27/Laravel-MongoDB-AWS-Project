                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="width:150px;">
                                                              <img alt="Logo" title="" height="auto" src="https://interncamp.ecell.org.in/logo"
                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      @yield('email_content')
                                                          ...
                                                          <p class="mb-0">Team R&D</p>
                                                          <p class="mb-0">KIIT E-Cell</p>
                                                           <p>Do Follow us on:</p>
                                                          <a href="https://m.facebook.com/kiitecell/?tsid=0.4797491596239032&source=result" target="_blank">
                                                          	<p class="mb-0">Facebook</p>
                                                          </a>
                                                          <a href="https://twitter.com/kiit_ecell" target="_blank">
                                                          	<p class="mb-0">Twitter</p>
                                                          </a>
                                                          <a href="https://www.linkedin.com/company/kiitecell/" target="_blank">
                                                          	<p class="mb-0">Linkedin</p>
                                                          </a>
                                                          <a href="https://www.quora.com/profile/KIIT-E-Cell-Official" target="_blank">
                                                          	<p class="mb-0">Quora</p>
                                                          </a>

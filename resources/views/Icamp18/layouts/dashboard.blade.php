									...
									<ul class="m-topbar__nav m-nav m-nav--inline">										
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												...
												<span class="m-topbar__username">{{$data->name or 'New User'}}</span>	
													...
													<div class="m-dropdown__header m--align-center" style="background: url(/Icamp18/assets_dash/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
														<div class="m-card-user m-card-user--skin-dark">
															...
															<div class="m-card-user__details">
																<span class="m-card-user__name m--font-weight-500">{{$data->name or 'New User'}}</span>
																<a href="" class="m-card-user__email m--font-weight-300 m-link">{{$data->email or 'New User'}}</a>
															</div>
														</div>
													</div>
							...
							<div class="m-stack__item m-stack__item--middle m-stack__item--fluid">
								...
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >		
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										...
										<li class="m-menu__item{{ Request::is('startups/selected') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="/startups/selected" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">Applied Companies</span>
											</a>
										</li>
										<li class="m-menu__item{{ Request::is('startups/bookmarks') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="/startups/bookmarks" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">Bookmarks</span>
											</a>
										</li>
										...
										<li class="m-menu__item{{ Request::is('profile/resume') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="/profile/resume" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">Upload Resume</span>
											</a>
										</li>
										

										<li class="m-menu__item{{ Request::is('aiesec') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="/aiesec" class="m-menu__link ">
												<span class="m-menu__item-here"></span>
												<span class="m-menu__link-text">International Internship by AIESEC</span>
											</a>
										</li>

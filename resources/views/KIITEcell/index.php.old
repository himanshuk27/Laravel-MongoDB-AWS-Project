...
/* 
 	...
 	$active = ' class="active"';
		...
		$active = ' class="active"';
//include('KIITEcell/php/intialize.php');
include 'KIITEcell/php/header.php';
?>
		...
		<div role="main" class="main">
		 ...
		 <br>
			...
			<div class="row center">
									...
									<div class="project-image">
										<div class="box-image">
											...
											<div id="fcSlideshow" class="fc-slideshow appear-animation" data-appear-animation="zoomIn" data-appear-animation-duration="300" data-appear-animation-delay="2900">
												<ul class="fc-slides">
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="KIITEcell/assets/images/logo.png" alt="" /></a></li>
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="KIITEcell/assets/images/logo.png" alt="" /></a></li>
													<li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="KIITEcell/assets/images/logo.png" alt="" /></a></li>
												</ul>
											</div>
				...
				<?php include ("KIITEcell/php/footer.php"); ?>	

...
<html lang="en" >
				...
				<div class="m-grid__item m-grid__item--fluid m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img style="width: 250px;" src="//interncamp.ecell.org.in/logo">
							</a><br><br>
							<h4>Icamp '18 Offline Payment</h4>
						</div>
						...
						<div class="m-login__signin">
							...
							<form id="loginForm" name="loginForm" class="m-login__form m-form" action="/searchregistration" method="POST">
								...
								<div class="m-login__form-action">
									<input id="but_submit" class="btn btn-info m-btn m-btn--custom m-btn--air m-login__btn m-login__btn--primary" type="submit" value="Search">
	...
	<div class="m-widget1__item">
		<div class="row m-row--no-padding align-items-center">
			<div class="col">
				<h3 class="m-widget1__title">Applied Companies</h3>
				
			</div>
			<div class="col">
				<span class="m-widget1__number m--font-info roll apply_comp"></span>
			</div>
		</div>
	</div>

	<div class="m-widget1__item" id="cashpayic" style="display: none;">
		<div class="row m-row--no-padding align-items-center">			
			<!--div class="col">
				Receipt No: &nbsp;<input type="number" id="t_id">
				<br>
				<br>
				Amount: &nbsp; <select id="amount" name="amount"><option value="300">Rs. 300</option>
				...
				<br>
				<br>
				<button id="but_ic_cash" class="btn btn-info m-btn m-btn--custom m-btn--air m-login__btn m-login__btn--secondary">Icamp Cash Pay</button>
			</div-->
		</div>
	</div>
	<br>	
		...
		<script type="text/javascript">
			$('#but_ic_cash').click(function(){

				var t_id = $('#t_id').val();
				var amount = $('#amount option:selected').val()

				var addr = 'http://cockpit.ecell.org.in/cashpay/ic/pay?t_id='+t_id+'&amount='+amount;
  ...
  $(".apply_comp").append(value+'<br>');
});

             
             	$("#cashpay").css("display", "block");
             	if(response.Status != true)
             	$("#cashpayic").css("display", "block");

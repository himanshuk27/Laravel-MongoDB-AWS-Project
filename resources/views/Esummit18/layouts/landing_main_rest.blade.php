...
<html lang="en">
    ...
    <meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
        ...
        <link rel="stylesheet" type="text/css" href="Esummit18/assets/vendors/revolution/css/navigation.css">
                ...
                <div class="container">
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <ul class="nav menuzord-menu pull-right light op-nav">
                            ...
                            <li>
                                <a href="/#aboutus">About E-Summit '18 </a>
                            </li>
                            <li>
                                <a href="speakers">Previous Speakers</a>
                            </li>
                                 <li><a href="javascript:void(0)">Tracks</a>
                            <ul class="dropdown">
                                <li><a href="innovationtrack">Innovation Track</a></li>
                                <li><a href="https://esummit.org.in/businesstrack">Business Track</a></li>
                                <li><a href="https://esummit.org.in/techtrack">Tech Track</a></li>
                                <li><a href="https://esummit.org.in/startuptrack">Startup Track</a></li>
                            </ul>
                        </li>
                            <!--li>
                            ...
                            <li>
                                <a href="/#join" class="join-btn">Register</a>
                            </li>
                            <li>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                         ...
                         <span class="">For Website Queries,contact +91 9434583497(Soumyadeep)</span><br>
                            ...
                            <span class="copy-text">For Track Queries,contact +91 9434583497 (Sam)</span> 
                         &nbsp; | &nbsp;

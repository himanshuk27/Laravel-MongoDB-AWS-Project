    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h2 class="text-bold">&nbsp;YouTuber Sessions
                </h2>
                ...
                <div class="gallery-thumb">
                    <ul class="slides">
                        ...
                        <li data-thumb="Esummit18/assets/img/mission.png">
                         ...
                         <li data-thumb="Esummit18/assets/img/business.png">
                            <div style="width: 100%; height: 400px;" id="vid_workshop_3"></div>
                        </li>
                         <li data-thumb="Esummit18/assets/img/busy_man.png">
                            <div style="width: 100%; height: 400px;" id="vid_workshop_4"></div>
                        </li>
                    </ul>
                </div>
            </div>
...
<section class="content-promo-box padding-top-100 padding-bottom-120 gray-bg" id="tracks">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <a href="startuptrack" target="_blank">                <div class="featured-item border-box radius-4 hover brand-hover-startup">
            ...
            <div class="col-md-12">
                ...
                <div class="round-tab text-center">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li role="presentation"  class="active"><a href="#tab-26" class="waves-effect waves-light" role="tab" data-toggle="tab">Opening Ceremony</a></li>
                        <li role="presentation"><a href="#tab-22" class="waves-effect waves-light" role="tab" data-toggle="tab"> Innovation Track</a></li>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in" id="tab-22">
                                <p>
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>10 AM - 11 AM</th>
                                                        <td>"Brand first or Sell first" <br>
                                                        Venue:&nbsp; C7- AUDI <br>
                                                    Speaker:&nbsp;Saurabh Uboweja, Founder, CEO & Chief Brand Strategy, Brands of Desire </td>
                                                        
                                                        <td rowspan="8">MAKOVATION <br>
                                                            Venue:&nbsp;Campus-6, Conference Hall 5




                                                        </td>
                                                        <td rowspan="1">WOMEN IN TECHNOLOGY AND CONNECTED DEVICES <br>
                                                            Speaker:&nbsp;DIKSHA DEO, Founder & Chief Innovation Officer, IncubSENCE<br>
                                                            Venue:&nbsp;Audi, C6				
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td rowspan="3">MAKOVATION PITCHING SESSION <br>
                                                        Venue:&nbsp;CAMPUS 12, AUDI</td>
                                                    ...
                                                    <tr>
                                                        <th>3 PM - 4 PM</th>
                                                        <td rowspan="2">MAKOVATION PITCHING SESSION <br>
                                                        Venue:&nbsp; CAMPUS 12, AUDI
                                                    ...
                                                    <tr>
                                                        <th>5 PM - 6 PM</th>
                                                        <td rowspan="2">"The MAD Talk" by Mad Over Marketing(Siddhant Moore, Founder MOM) <br>
                                                           Venue:&nbsp; C7- AUDI
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>6 PM - 7 PM</th>
                                                        <td>Cool Session-"Making money with Youtube and Coding"(C6- AUDI) by Hitesh Choudhary, Tech Video Creator at Youtube  </td>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>"Brand first or Sell first" <br>
                                                        Venue:&nbsp; C7- AUDI <br>
                                                        Venue:&nbsp; Saurabh Uboweja, Founder, CEO & Chief Brand Strategy, Brands of Desire  </td>
                                                        <td rowspan="3">
                                                        ...
                                                        <td>"WOMEN IN TECHNOLOGY AND CONNECTED DEVICES" <br>
                                                        Speaker:&nbsp;  DIKSHA DEO <br>
                                                    Venue:&nbsp;SEMINAR HALL 1, C6 </td>

                                                    </tr>
                                                    <tr>
                                                        <th>11 AM - 12 PM</th>
                                                        <td >"An opportunity to become your own Boss" BY ASHISH MOHANTY, Founder 9start <br>
                                                           Venue:&nbsp; C-7, AUDI
                                                        </td>
                                                        <td rowspan="3">BUSINESS SIMULATION GAME <br>
                                                        Venue:&nbsp; Conference Hall-5, Campus 6
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>"Creating an Innovation Mindset (The Change Begins with You)" BY AKASH SHUKLA, C12, Audi</td>
                                                    ...
                                                    <tr>
                                                        <th>2 PM - 3 PM</th>
                                                        <td rowspan="3">"HOW TO BUILD A CASE STUDY" <br>
                                                        Venue:&nbsp; Campus 7- AUDI
                                                        <td rowspan="3"> 
                                                        Session on SEO,SMO, and Adwords <br>
                                                            Venue:&nbsp;Campus 7- AUDI <br>
                                                            Speaker:&nbsp; ADVIT SAHADEV, Head of marketing infibeam
                                                        </td>



                                                        </td>
                                                        <td rowspan="4">CASE STUDY COMPETITION <br>
                                                            Venue:&nbsp;Campus 7- AUDI
                                                    ...
                                                    <tr>
                                                        <th>3 PM - 4 PM</th>
                                                        <td rowspan="2">BUSINESS SIMULATION GAME <br>
                                                            Venue:&nbsp;CH-5, C6
                                                    ...
                                                    <tr>
                                                        <th>5 PM - 6 PM</th>
                                                        <td rowspan="2">"The MAD Talk" by Mad Over Marketing(Siddhant Moore, Founder MOM) <br>
                                                            Venue:&nbsp;C7- AUDI <br> (Open for All Participants)
                                                        </td>
                                                        <td rowspan="2">Closing Ceremony
                                                        </td>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>10 AM - 11 AM</th>
                                                        <td>"Brand first or Sell first" <br>
                                                        Venue:&nbsp;Campus 7- AUDI) Saurabh Uboweja, Founder, CEO & Chief Brand Strategy, Brands of Desire (Open for All Participants) </td>
                                                        <td rowspan="2">DESIGN MEETUP (Audi-8, Campus 12) <br>
                                                        Speaker:&nbsp; RAMAKRISHNA V
                                                        </td>
                                                        <td>"WOMEN IN TECHNOLOGY AND CONNECTED DEVICES" BY DIKSHA DEO(SEMINAR HALL 1, Campus 6) </td>

                                                    </tr>
                                                    <tr>
                                                        <th>11 AM - 12 PM</th>
                                                        <td rowspan="2">FlytCODE <br>
                                                            Venue:&nbsp;C-6, BANQUET HALL <br>
                                                            Speaker:&nbsp;  ACHAL NEGI, Head of Business Development FLYTBASE Inc	
	</td>
                                                        <td rowspan="3">FlytCODE (Conference Hall-8, Campus-6) and WORKSHOP ON BLOCKCHAIN (SEMINAR HALL 1, Campus-6)
                                                    ...
                                                    <tr>
                                                        <th>12 PM - 1 PM</th>
                                                      <!--   <td>FlytCODE (Conference Hall-5, Campus-6)</td> -->
                                                        <td rowspan="6">FlytCODE <br>
                                                         Venue:&nbsp;Campus 12 Auditorium <br>
                                                        <strong>AND</strong>
                                                        Workshop on AR/VR <br>
                                                        Venue:&nbsp;Campus 6 Computer Lab
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>2 PM - 3 PM</th>
                                                        <td rowspan="3">fLYTcode(Campus-6, BANQUET HALL)

                                                        </td>
                                                        <td rowspan="4">FlytCODE (Conference Hall-5, Campus-6) and WORKSHOP ON AR/VR Lab C6</td>
                                                        <td>Lunch Break</td>
                                                    ...
                                                    <tr>
                                                        <th>3 PM - 4 PM</th>
                                                        <td rowspan="2">FlytCODE (Conference Hall-8, Campus 6) and WORKSHOP ON BLOCKCHAIN (SEMINAR HALL 1, Campus 6)
                                                    ...
                                                    <tr>
                                                        <th>5 PM - 6 PM</th>
                                                        <td rowspan="2">"The MAD Talk" by Mad Over Marketing(Siddhant Moore, Founder MOM)&nbsp;
                                                        Venue:&nbsp; Campus-7 AUDI) <br>(Open for All Participants)
                                                        </td>
                                                        <td rowspan="2">Closing Ceremony
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>6 PM - 7 PM</th>
                                                        <td>Cool Session-"Making money with Youtube and Coding" <br>
                                                        Venue:&nbsp;Campus-6 AUDI <br>
                                                        Speaker:&nbsp; Hitesh Choudhary, Tech Video Creator at Youtube (Open for All Participants) </td>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab-25">
                                <p>
                                    <div class="col-xs-12">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>"Brand first or Sell first" <br>
                                                        Venue:&nbsp;C7- AUDI <br>
                                                    Speaker:&nbsp;Saurabh Uboweja, Founder, CEO & Chief Brand Strategy, Brands of Desire (Open for All Participants)			</td>
                                                        <td rowspan="3">STARTUP MEET in Association with Google Business Group (CH-6, C6)
</td>
                                                        <td>"WOMEN IN TECHNOLOGY AND CONNECTED DEVICES" <br>
                                                        Speaker:&nbsp;DIKSHA DEO <br>
                                                    Venue:&nbsp; SEMINAR HALL 1, Campus-6				</td>

                                                    </tr>
                                                    <tr>
                                                        <th>11 AM - 12 PM</th>
                                                         <td rowspan="2">STARTUP MEET in Association with Google Business Group <br>
                                                         Venue:&nbsp; COnference Hall-6, Campus-6</td>
                                                         <td rowspan="3">STARTUP MEET in Association with Google Business Group <br>
                                                         Venue:&nbsp; COnference Hall-6, Campus-6</td>
                                                    ...
                                                    <tr>
                                                        <th>2 PM - 3 PM</th>
                                                        <td rowspan="3"> STARTUP MEET in Association with Google Business Group <br>
                                                         Venue:&nbsp; COnference Hall-6, Campus-6
                                                        ...
                                                        <td rowspan="4">STARTUP MEET in Association with Google Business Group <br>
                                                         Venue:&nbsp; COnference Hall-6, Campus-6
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="tab-26">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <h4 style="line-height: 30px;">
                                            It is with great pleasure that we write to invite you to the inauguration ceremony of KIIT E-Summit’18. <br>
<strong>Venue: Auditorium, Campus 6</strong><br>
<strong>Time: 2.30 PM</strong><br>
You are requested to be present at the venue on the given time as we will be distributing the participant ID cards and the delegate kit. 
...
<script type="text/javascript">
    function newsletterModal() {
        swal({
            title: '<img class="mail-icon" src="https://esummit.org.in/logo">',
            html: '<br><h3><strong>Enter you email to get,<br> our latest news before everybody else.</h3><br><br>',
            input: 'email',
...
<script>
    ...
    function onYouTubePlayerAPIReady() {
        ...
        player2 = new YT.Player('vid_workshop_2', {
         ...
         player3 = new YT.Player('vid_workshop_3', {
            videoId: 'aAHcGQx5GLA', <!-- video id should be here. last component from video URL -->
            events: {
                'onReady': onPlayerReady,
                'onStateChange': onPlayerStateChange
            }
        });
         player4 = new YT.Player('vid_workshop_4', {
            videoId: 'Lg1e791sGR4', <!-- video id should be here. last component from video URL -->
            events: {
                'onReady': onPlayerReady,
                'onStateChange': onPlayerStateChange
            }

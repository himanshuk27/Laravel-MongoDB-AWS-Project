...
<div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;">
                                                        ...
                                                        <p>Have we got the right email address to reach you on? To confirm that you can access the KIIT E-Summit'18 dashboard and finish the sign up process, just click the button below.</p>
                                                        <p>
                                                          <a href="https://esummit.org.in/email/verify/{{$data['token']}}" class="btn" mc:disable-tracking="">Confirm my email address</a>
                                                        </p>
